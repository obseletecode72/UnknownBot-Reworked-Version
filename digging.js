...
function inject (bot) {
  ...
  function digTime (block) {
    ...
    let blockWater = bot.blockAt(bot.entity.position.offset(0, 1.62, 0));
    return block.digTime(type, creative, (blockWater && blockWater.name == "water"), !bot.entity.onGround, enchantments, bot.entity.effects)
  }
